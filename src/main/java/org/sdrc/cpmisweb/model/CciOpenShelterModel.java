...
public class CciOpenShelterModel implements Serializable{
	
    /**
	 * 
	 */
	private static final long serialVersionUID = 8697119197214462385L;
	private Integer id;
    private List<CciOpenShelterTraining> cciOpenShelterTrainings;  
