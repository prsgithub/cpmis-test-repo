...
<title>CCI Observation Home</title>
<link rel="stylesheet"
...
<!-- 				</div></a> -->
<!-- 				<button type="submit" class="col-md-6 savebtn submitbtn"> -->
<!-- 					<img class="saveSvg"  ng-click="checkSubmit()" -->
<!-- 						src="resources/image/svgIcons/SVG_submit_icon.svg" width="18" -->
<!-- 						height="18" /> <a href="#"><h5 class="borderright1">SUBMIT</h5></a> -->
<!-- 				</button> -->
<!-- 			</div> -->
			<h5 class="cwcHeading">Observation Home  <br>  Monthly Report</h5>
				...
				<div class="formHeading2">
					...
					<div class="col-md-12">
						<h4 class="headingBottom1">
							Observation Home&nbsp;Monthly Report for Month of <b
							...
							<div>
								...
								<div class="form-group labelFont">
									...
									<div class="col-md-6">
										<select ng-options="item as item.typeDetailsName for item in childSex"
											ng-model="selectedChildSex" ng-value="item.typeDetailsId"
											class="form-control inputBackgroundgeneral" required
											ng-disabled="cciForm.submitted">
											<option value="" disabled selected>Select</option>
										</select>
										<!--ng-model="cciForm.typeOfInstitutions" -->
									</div>
								</div>
								<div class="form-group labelFont">
									<label class="col-md-6 control-label labelLeftAlign"
									...
									<div class="col-md-6">
										<select ng-options="item as item.typeDetailsName for item in osType"
											ng-model="selectedOsType" ng-value="item.typeDetailsId"
											class="form-control inputBackgroundgeneral" required
											ng-disabled="cciForm.submitted">
											<option value="" disabled selected>Select</option>
										</select>
										<!-- 							ng-model="cciForm.govtNonGovt" -->
									</div>
								</div>
								<div class="form-group labelFont">
									<label class="col-md-6 control-label labelLeftAlign"
										...
										<tr>
											<td><label
												class="col-md-12 control-label labelLeftAlign totalFont"> C.1.
													Total children in the month</label></td>
										...
										<tr>
											<td><label
												class="col-md-12 control-label labelLeftAlign totalFont"> E.1.
													Total children on the last day the month</label></td>
                                             ...
                                             <tbody>
                                                  <tr>
                                                       <td class="tabletdWidthmoreThannfour">
                                                            <div class="textAlign">
                                                                 <label class="control-label" for="textinput">F.1. No. of Children </label>
                                                            </div>
                                                       </td>
                                                       ...
                                                       <td><input type="number" id="fMinority"  required
                                                           ng-model="cciForm.fMinority"
                                                            ng-disabled="cciForm.submitted"
                                                            class="form-control inputBackground tableinputWidth removeExponentialValueE "
                                                             only-four-digits></td>
                                                  </tr>
								...
								<table class="table table-bordered table-margintop" id="tableJ">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="5"><input type="number" disabled
										...
										<tr>
											...
											<td><input type="number" required only-four-digits
												id="j3MovedOutMonths3to4"  ng-keyup="checkJNegetive('j3MovedOutMonths3to4','j4TotalMonths3to4','(3-4 months)')"
											...
											<td><input type="number" required only-four-digits
												id="j3MovedOutMonths4to12"  ng-keyup="checkJNegetive('j3MovedOutMonths4to12','j4TotalMonths4to12','(4-12 months)')"
								...
								<div class="form-group labelFont">
									...
									<div class="col-md-6">
										<input type="number" required
											...
											ng-model="cciForm.l1aNoOfTraining"
											ng-disabled="cciForm.submitted" id="l1aNoOfTraining"
											class="form-control inputBackground removeExponentialValueE">
									</div>
								</div>
												...
												<div class="form-group labelFont">
													...
													<div class="col-md-6">
														<input type="number" 
															...
															id="30days" limit-to="2" only-four-digits
															ng-disabled="cciForm.submitted"
														 ...
														 <div class="col-md-6 topicOftrainingListJJb">
                                                                 ...
                                                                 <li>
																	<div class="checkboxstyle">
																		<input id="JJActRule" type="checkbox" ng-disabled="cciForm.submitted"
																 ...
																 <li>
																	<div class="checkboxstyle">
																		<input id="LawsandICPS" type="checkbox" ng-disabled="cciForm.submitted"
																 ...
																 <li>
																	<div class="checkboxstyle">
																		<input id="POCSOAct" type="checkbox" ng-disabled="cciForm.submitted"
																...
																<li>
																	<div class="checkboxstyle">
																		<input id="CPMISTrackchildCLTSTrackchild" type="checkbox" ng-disabled="cciForm.submitted"
																 ...
																 <li>
																	<div class="checkboxstyle">
																		<input id="Combinedtraining" type="checkbox" ng-disabled="cciForm.submitted"
																...
																<li>
																	<div class="checkboxstyle">
																		<input id="CPMISTrackchildCLTS" type="checkbox" ng-disabled="cciForm.submitted"
																...
																<li>
																	<div class="checkboxstyle">
																		<input id="CPMISTrackchildCPMIS" type="checkbox" ng-disabled="cciForm.submitted"
																 ...
																 <li>
																	<div class="checkboxstyle">
																		<input id="Others" type="checkbox" ng-disabled="cciForm.submitted"
...
<br> <br> <br> <br>&nbsp;<br> <br>
	...
	<div class="modal fade autoSaveModal" id="successModalForAutoSaveOH"
          data-keyboard="false" data-backdrop="static" tabindex="-1"
          role="dialog">
          <div class="modal-dialog">
               <div class="col-md-12 modal-content modalView">
	...
	<script src="resources/js/controllers/cciController.js"></script>
