...
/**
 * @author Pratyush(pratyush@sdrc.co.in) created on : 08-Mar-2018 5:14:30 pm
 */
public class CciSHModel implements Serializable{
	
	private static final long serialVersionUID = 2036149415177590715L;
	private Integer id;    
