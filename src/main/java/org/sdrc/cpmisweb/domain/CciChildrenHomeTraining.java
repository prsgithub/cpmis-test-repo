 ...
 * created on: 31-Oct-2017 1:56:16 pm
 */
@Entity
@Table(name="cci_children_home_training")
public class CciChildrenHomeTraining {
		...
		public CciChildrenHome getChId() {
			return chId;
		}

		public void setChId(CciChildrenHome chId) {
			this.chId = chId;
		}
