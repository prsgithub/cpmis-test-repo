...
/**
 * @author Pratyush(pratyush@sdrc.co.in) created on : 08-Mar-2018 5:11:59 pm
 */
@Entity
@Table(name="cci_sh_training")
public class CciSHTraining {
	@Id
	...
	public CciSH getHomeId() {
		return homeId;
	}

	public void setHomeId(CciSH homeId) {
		this.homeId = homeId;
	}
